...
MEAN_FILL = [int(0.485 * 255), int(0.456 * 255), int(0.406 * 255)]
...
if __name__ == "__main__":
    ...
    from torch.utils.data import DataLoader
    processor = InternVLProcessor.from_pretrained("/mm/internvl/project/hf/models/InternVL3_5-HF")
    dataset = SFTDataset(processor,"hi", "/mm/internvl/trl_free/data/all_train.parquet",None)
    dataset[0]